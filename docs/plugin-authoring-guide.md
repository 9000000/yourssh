...
6. [Lifecycle & hot-reload](#6-lifecycle--hot-reload)
7. [Security & permissions](#7-security--permissions)
8. [Ví dụ thực tế](#8-ví-dụ-thực-tế)
9. [Debugging](#9-debugging)
10. [Checklist trước khi publish](#10-checklist-trước-khi-publish)
...
Logs hiện trong **Plugin Console** (Settings → Script Plugins → plugin → Console).

---

## 6. Lifecycle & hot-reload
