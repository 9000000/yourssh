  ...
  void _openInputConnection() {
    ...
    if (hasInputConnection) {
      ...
      final config = TextInputConfiguration(
        // YOURSSH PATCH (upstream issue #207): Flutter's multi-view text
        // input requires the hosting view's id. Without it the Windows
        // engine rejects TextInput.setClient ("view ID is null"), so
        // printable keys never reach the terminal while Enter/Tab/paste
        // still work via the hardware-key path.
